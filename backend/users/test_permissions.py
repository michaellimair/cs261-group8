...
class TestIsOwner(PermissionTestMixIn):
  ...
  def test_has_permission_false(self):
    ...
    self.assertFalse(self.permission.has_object_permission(self.request, None, self.object))

  def test_has_permission_true(self):
    force_authenticate(self.request, user = self.user)
    self.request.user = self.user

    self.assertTrue(self.permission.has_object_permission(self.request, None, self.object))
